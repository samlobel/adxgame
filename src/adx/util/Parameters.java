...
public class Parameters {
  ...
  // Allowable games.
  public static final ImmutableSet<String> allowableGames = ImmutableSet.of("ONE-DAY-ONE-CAMPAIGN", "TWO-DAYS-ONE-CAMPAIGN", "TWO-DAYS-TWO-CAMPAIGNS", "CS1951K-FINAL");
