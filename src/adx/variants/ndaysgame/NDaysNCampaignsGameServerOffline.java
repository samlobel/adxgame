 ...
 */
public class NDaysNCampaignsGameServerOffline extends OfflineGameServer {
	 ...
	 * @throws AdXException
	 */
	public NDaysNCampaignsGameServerOffline() throws IOException, AdXException {
		super();
	}
	...
	public static void main(String[] args) {
		try {
			...
			new NDaysNCampaignsGameServerOffline().runAdXGame();
