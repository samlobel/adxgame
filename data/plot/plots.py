...
def plotGroup(dir_location, image_prefix, agent1, agent2, fixagent1, max_number_agents = 20):
    """
    ...
    pl.savefig('../plot/' + image_prefix + (agent1+'v'+agent2 if fixagent1 else agent2+'v'+agent1) + '.png')

def produce_all_plots(dir_location, image_prefix):
    """
...
for (demand, supply) in product(demand_factors, impressions):
    ...
    #produce_all_plots(dir_location, image_prefix)    
    latex = """
\\newpage
