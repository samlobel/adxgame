...
def plotGroup(dir_location, image_prefix, agent1, agent2, fixagent1):
    ...
    fig, ax = pl.subplots(nrows=4, ncols=1, sharex=True)
...
def produce_all_plots():
    ...
    #dir_location = '../results0.75-2k-newreward/'
    #image_prefix = 'demand-factor-0.75-2kimpressions-newreward-'

    #dir_location = '../results1.25-2k-newreward/'
    #image_prefix = 'demand-factor-1.25-2kimpressions-newreward-'

    #dir_location = '../results0.75-10k-newreward/'
    #image_prefix = 'demand-factor-0.75-10kimpressions-newreward-'

    #dir_location = '../results1.25-10k-newreward/'
    #image_prefix = 'demand-factor-1.25-10kimpressions-newreward-'
