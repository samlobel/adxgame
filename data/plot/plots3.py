...
xaxis = [0.01 + 0.01*x for x in range(0,100)]
...
pl.title('Market maker revenue as a funciton of reserve, ' + str(number_agents1) + ' WE, ' + str(number_agents2) + 'WF')
pl.savefig('../plot/' + 'WEWF(' + str(number_agents1) + ',' + str(number_agents2) + ')vMarketRevenue.png')
